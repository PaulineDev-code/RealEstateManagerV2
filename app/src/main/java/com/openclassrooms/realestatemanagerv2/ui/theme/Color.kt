package com.openclassrooms.realestatemanagerv2.ui.theme
...
val Green: Color = Color(0xFF018786)

val LightBlueLightTheme: Color = Color(0xFFCFD6FF)
val LightBlueDarkTheme: Color = Color(0xFFD5DBFF)
